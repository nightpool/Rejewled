...
public class DejewledPacket56 extends Packet56MapChunkBulk {
	...
	static{
		try {
	        ...
	        m.invoke(null, 56+0xf00, true, false, DejewledPacket56.class); // will never be sent over the wire, so it doesn't matter.
		} catch (Exception e){
			e.printStackTrace();
		}
	}
	public DejewledPacket56(JeweledConnection con, Packet56MapChunkBulk packet) {
		try {
