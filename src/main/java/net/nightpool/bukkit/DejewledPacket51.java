...
public class DejewledPacket51 extends Packet51MapChunk {

	public int size;
	public byte[] buffer;
	public JeweledConnection con;
	...
	static{
		try {
	        ...
	        m.invoke(null, 51+0xf00, true, true, DejewledPacket51.class); // will never be sent over the wire, so it doesn't matter.
		} catch (Exception e){
			e.printStackTrace();
		}
	}

	public DejewledPacket51(JeweledConnection con, Packet51MapChunk packet) {
		try {
